    ...
    public partial class Form1 : Form
    {
        ...
        private void AddRowButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Object[] CustRecord = { "ALFKI", "Alfreds Futterkiste", "Maria Anders", "Sales Representative", "Obere Str. 57", "Berlin", "Germany", "030-0074321\",\"030-0076545" };
            ...
            {
                MessageBox.Show("Неверный CustomerID");
            }
            catch (Exception ex)
            {
