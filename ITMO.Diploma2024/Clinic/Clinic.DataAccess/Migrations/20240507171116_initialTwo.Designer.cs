...
namespace Clinic.DataAccess.Migrations
{
    ...
    [Migration("20240507171116_initialTwo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinic.DataAccess.Models.AdressEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clinic.DataAccess.Models.ResultEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clinic.DataAccess.Models.DepartmentEntity", b =>
                {
                    b.HasOne("Clinic.DataAccess.Models.AdressEntity", "Adress")
                        .WithOne("Department")
                        .HasForeignKey("Clinic.DataAccess.Models.DepartmentEntity", "AdressId")
            ...
            modelBuilder.Entity("Clinic.DataAccess.Models.UserEntity", b =>
                {
                    b.HasOne("Clinic.DataAccess.Models.AdressEntity", "Adress")
                        .WithOne("User")
                        .HasForeignKey("Clinic.DataAccess.Models.UserEntity", "AdressId");
