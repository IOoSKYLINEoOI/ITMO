        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentNumber = table.Column<int>(type: "int", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_Adresses_AdressId",
                        column: x => x.AdressId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeDepartmentEntity", x => new { x.EmployeeId, x.DepartmentId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmployeeDepartmentEntity_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Results_Receptions_ReceptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDepartmentEntity_PositionId",
                table: "EmployeeDepartmentEntity",
                column: "PositionId");
