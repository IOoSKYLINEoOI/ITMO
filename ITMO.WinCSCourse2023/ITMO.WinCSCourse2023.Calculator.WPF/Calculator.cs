...
namespace Calculator
{
	...
	public class CalcEngine
	{
        ...
        {
			return System.Convert.ToString(Math.Sqrt(System.Convert.ToDouble(stringAnswer)));
        }
        public static string CalcSQRT3()
        {
            return System.Convert.ToString(Math.Pow(System.Convert.ToDouble(stringAnswer), 1.0/3.0));
        }

        public static string CalcObr()
        {
			return System.Convert.ToString(1 / (System.Convert.ToDouble(stringAnswer)));
        }

        public static string CalcSqare()
        {
            return System.Convert.ToString(Math.Pow(System.Convert.ToDouble(stringAnswer), 2));
        }

        public static string CalcFact()
        {
			long factorial = 1;
            for (int i = 1; i <= System.Convert.ToDouble(stringAnswer); i++)
                factorial *= i;

            return System.Convert.ToString(factorial);
        }
